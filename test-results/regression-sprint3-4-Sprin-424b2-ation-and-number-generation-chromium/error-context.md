...
- Name: regression-sprint3-4.spec.ts >> Sprint 3+4 Regression >> 5. Create permit — form validation and number generation
- Location: __tests__/e2e/regression-sprint3-4.spec.ts:83:7
...
Locator:  locator('dialog, [role="dialog"]')
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('dialog, [role="dialog"]')
    9 × locator resolved to <div tabindex="-1" role="dialog" aria-modal="true" data-has-footer="true" data-nextjs-dialog="true" class="error-overlay-dialog-scroll" data-nextjs-scrollable-content="true" aria-labelledby="nextjs__container_errors_label" aria-describedby="nextjs__container_errors_desc">…</div>
          ...
          - generic [ref=e90]:
            - link [ref=e91] [cursor=pointer]:
              ...
              - button [ref=e92]:
                - img
            - generic [ref=e93]:
              - heading "Новый наряд-допуск" [level=1] [ref=e94]
              - paragraph [ref=e95]: Регистрация наряда-допуска на проведение работ
          - generic [ref=e96]:
            - generic [ref=e97]:
              - generic [ref=e98]:
                - generic [ref=e99]: Категория работ *
                - combobox [ref=e100]:
                  - generic [ref=e101]: Выберите категорию
                  - img: ▼
                - textbox [ref=e102]
              - generic [ref=e103]:
                - generic [ref=e104]: Подрядчик *
                - combobox [ref=e105]:
                  - generic [ref=e106]: Выберите подрядчика
                  - img: ▼
                - textbox [ref=e107]
            - generic [ref=e108]:
              - generic [ref=e109]: Участок работ *
              - textbox "г. Москва, ул. ..., д. ..." [ref=e110]
            - generic [ref=e111]:
              - generic [ref=e112]: Ответственный *
              - textbox "Иванов И.И." [ref=e113]
            - generic [ref=e114]:
              - generic [ref=e115]:
                - generic [ref=e116]: Дата открытия *
                - textbox [ref=e117]
              - generic [ref=e118]:
                - generic [ref=e119]: Срок действия *
                - textbox [ref=e120]
            - generic [ref=e121]:
              - link "Отмена" [ref=e122] [cursor=pointer]:
                - /url: /permits
                - button "Отмена" [ref=e123]
              - button "Создать" [ref=e124]
  - alert [ref=e125]
```
